...
{
    class Stage_2 : RC_GameStateParent
    {
        Sprite3 enemyBase1 = null;
        Sprite3 enemyBase2 = null;
        Sprite3 enemyBase3 = null;
        Sprite3 enemyBase4 = null;

        SpriteList enemyBase = null;
        ...
        public override void LoadContent()
        {
            ...
            background = new ImageBackground(Game1.texBack2, Color.White, graphicsDevice);
            ...
            bullet = new Sprite3(false, Game1.texBullet, main.getPosX() + main.getWidth() / 2, main.getPosY() + main.getHeight() / 2);
            ...
            coin1 = new Sprite3(true, Game1.texCoin, rnd.Next(10, 500), rnd.Next(0, 500));
            coin1.setXframes(8);
            coin1.setYframes(1);
            ...
            coin2 = new Sprite3(true, Game1.texCoin, rnd.Next(500, 1000), rnd.Next(0, 500));
            coin2.setXframes(8);
            coin2.setYframes(1);
            coin2.setWidthHeight(64, 64);
            coin2.setBB(5, 5, 50, 54);
            coin2.setAnimationSequence(seq, 0, 7, 5);
            ...
            enemy1 = new Sprite3(true, Game1.texEnemy2Stay, 550, -100);
            ...
            enemy2 = new Sprite3(true, Game1.texEnemy2Stay, 500, -100);
            ...
            enemy3 = new Sprite3(true, Game1.texEnemy2Stay, 550, -100);
            ...
            enemy4 = new Sprite3(true, Game1.texEnemy2Stay, 550, -100);
            enemy4.setHSoffset(new Vector2(enemy4.getWidth() / 2, enemy4.getHeight() / 2));
            enemy4.setBB(20, 15, 75, 90);
            enemy4.boundingSphereRadius = 60;

            enemyBase1 = new Sprite3(true, Game1.texGround, enemy1.getPosX() - 15, enemy1.getPosY() + 85);
            enemyBase1.setWidthHeight(105, 10);
            enemyBase1.setBB(0, 0, 64, 55);

            enemyBase2 = new Sprite3(true, Game1.texGround, enemy2.getPosX() - 15, enemy2.getPosY() + 85);
            enemyBase2.setWidthHeight(105, 10);
            enemyBase2.setBB(0, 0, 64, 55);

            enemyBase3 = new Sprite3(true, Game1.texGround, enemy3.getPosX() - 15, enemy3.getPosY() + 85);
            enemyBase3.setWidthHeight(105, 10);
            enemyBase3.setBB(0, 0, 64, 55);

            enemyBase4 = new Sprite3(true, Game1.texGround, enemy4.getPosX() - 15, enemy4.getPosY() + 85);
            enemyBase4.setWidthHeight(105, 10);
            enemyBase4.setBB(0, 0, 64, 54);
            ...
            enemyBase.addSpriteReuse(enemyBase1);
            enemyBase.addSpriteReuse(enemyBase2);
            enemyBase.addSpriteReuse(enemyBase3);
            enemyBase.addSpriteReuse(enemyBase4);
        ...
        {
            if (gameStart || Stage_1.startOver)
            {
                ...
                coin1.setPos(500, 500);
                coin2.setPos(900, 200);
                hit = 0;
                healthBar.currentHp = 100;
                bulletFired = false;
                takeInput = true;
                ...
                endTick = 0;
                hit = 0;
                if (Stage_1.startOver) { startOver = true; }
            ...
            enemyBase1.setPos(enemy1.getPosX() - 55, enemy1.getPosY() + 55);
            enemyBase2.setPos(enemy2.getPosX() - 55, enemy2.getPosY() + 55);
            enemyBase3.setPos(enemy3.getPosX() - 55, enemy3.getPosY() + 55);
            enemyBase4.setPos(enemy4.getPosX() - 55, enemy4.getPosY() + 55);
            ...
            if (moveEnemy)
            {
                ...
                else if ((enemyTurn == 5))
                {
                    ...
                    if (enemy2.getPosX() > main.getPosX()) { enemy2.setFlip(SpriteEffects.FlipHorizontally); xFireOffset2 = 11; } else { enemy2.setFlip(SpriteEffects.None); }
                    ...
                    if (enemy4.getPosX() > main.getPosX()) { enemy4.setFlip(SpriteEffects.FlipHorizontally); xFireOffset4 = 11; } else { enemy4.setFlip(SpriteEffects.None); }
                    ...
                    {
                        //if (Game1.score > Game1.highestScore) { Game1.highestScore = Game1.score; }
                        Game1.levelManager.pushLevel(4);
                        limSound3.Stop();
                    }
                }
            }
            ...
            if (hit == 4 && tick % 120 == 0) { Game1.levelManager.pushLevel(4); limSound3.Stop();
                if (Game1.score > Game1.highestScore) { Game1.highestScore = Game1.score; }
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(Font, "BEST SCORE " + (Game1.score * 100).ToString(), new Vector2(800, 10), Color.LightGoldenrodYellow);
        ...
        public void moveMinions()
        {
            ...
            enemy2.setTexture(Game1.texEnemy2Move, false);
            enemy3.setTexture(Game1.texEnemy2Move, false);
            enemy4.setTexture(Game1.texEnemy2Move, false);
            ...
            if (enemyTick % 100 == 0)
            {
                ...
                enemy2.setTexture(Game1.texEnemy2Stay, false);
                enemy3.setTexture(Game1.texEnemy2Stay, false);
                enemy4.setTexture(Game1.texEnemy2Stay, false);
        ...
        public void showBoundingBoxes()
        {
            ...
            enemyBase1.drawBB(spriteBatch, Color.White);
            enemyBase1.drawHS(spriteBatch, Color.Red);
            enemyBase2.drawBB(spriteBatch, Color.White);
            enemyBase2.drawHS(spriteBatch, Color.Red);
            enemyBase3.drawBB(spriteBatch, Color.White);
            enemyBase3.drawHS(spriteBatch, Color.Red);
            enemyBase4.drawBB(spriteBatch, Color.White);
            enemyBase4.drawHS(spriteBatch, Color.Red);
        }
        ...
        protected void bulletCollision()
        {
            ...
            int bc = enemyBase.collisionWithRect(bulletBB);
            ...
            {
                Sprite3 temp = enemyBase.getSprite(bc);
